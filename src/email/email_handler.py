...
class EmailHandler:
    ...
    def send_confirmation_email(self, applicants):
    ...
    def send_exam_schedule(self, applicants, exam_date_str):
    ...
    def check_confirmation(self, applicants_emails):
        ...
        try:
            ...
            confirmed = []
            for applicant_email in applicants_emails:
                ...
                if len(messages) > 0:
                    confirmed.append(applicant_email)

            return {"Number": len(confirmed) > 0, "list": confirmed} # Returns True if any messages found
